...
var LoginproProvider = (function () {
    ...
    LoginproProvider.prototype.iffollowing = function (user_id, us_id) {
        ...
        return this.http.put("http://localhost:3000/iffollowing/", body, { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpHeaders */]().set('Content-Type', 'application/json') });
    };
